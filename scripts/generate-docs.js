...
const cgus = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      bullet('Pro — 22,99 $/mois — quiz illimités, flashcards, plan d\'étude avec agenda, Mon Cartable'),
      bullet('Autodidacte — 35,99 $/mois — quiz illimités, flashcards, plan d\'étude avec agenda, tuteur IA, cours générés par l\'IA, communautés'),
