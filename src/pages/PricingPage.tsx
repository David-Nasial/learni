...
const planFree = [
  ...
  { label: 'Import PDF',                  ok: true  },
  { label: 'Historique basique',          ok: true  },
  { label: '10 questions max par quiz',   ok: true  },
  { label: '20 questions',                ok: false },
  { label: 'Caméra intelligente',         ok: false },
  { label: 'Flashcards IA',               ok: false },
  { label: 'Explications IA',             ok: false },
...
const planStarter = [
  ...
  { label: 'Import PDF (5 PDF/mois)',     ok: true  },
  { label: 'Historique complet cloud',    ok: true  },
  { label: '10 ou 20 questions',          ok: true  },
  { label: 'Explications IA de base',     ok: true  },
  { label: 'Statistiques de base',        ok: true  },
  { label: 'Caméra intelligente',         ok: false },
  { label: 'Flashcards IA',               ok: false },
  { label: 'Export PDF',                  ok: false },
  { label: 'Stats avancées & graphiques', ok: false },
]

const planPro = [
  { label: 'Quiz illimités',              ok: true  },
  { label: 'Import PDF illimité',         ok: true  },
  { label: 'Historique complet cloud',    ok: true  },
  { label: '10 ou 20 questions',          ok: true  },
  { label: 'Explications IA complètes',   ok: true  },
  { label: 'Caméra intelligente',         ok: true  },
  { label: 'Flashcards IA',               ok: true  },
  { label: 'Export PDF',                  ok: true  },
  { label: 'Stats avancées & graphiques', ok: true  },
]

const planAutodidacte = [
  { label: 'Tout ce qui est dans Pro',    ok: true  },
  { label: 'Tuteur IA conversationnel',   ok: true  },
  { label: 'Mode prof / débutant / exam', ok: true  },
  { label: 'Plan d\'étude intelligent',   ok: true  },
  { label: 'Calendrier & objectifs IA',   ok: true  },
  { label: 'Révisions espacées',          ok: true  },
  { label: 'Génération de cours complets',ok: true  },
  { label: 'Parcours personnalisé',       ok: true  },
]

const planTeacher = [
  { label: 'Tout ce qui est dans Pro',    ok: true  },
  { label: 'Tableau de bord professeur',  ok: true  },
  { label: 'Gestion de classes',          ok: true  },
  { label: 'Suivi individuel par élève',  ok: true  },
  { label: 'Résultats de toute la classe',ok: true  },
  { label: 'Code de classe élèves',       ok: true  },
  { label: 'Import de manuels partagés',  ok: true  },
  { label: 'Facturation mensuelle',       ok: true  },
]
    ...
    <div className="fade-in" style={{ maxWidth: 1100, margin: '0 auto', padding: '2rem 1.5rem' }}>
      ...
      <div style={{ maxWidth: 640, margin: '2.5rem auto 0' }}>
        ...
        {(isSchool ? [
          ...
          { q: 'À quoi sert le plan Starter ?', a: "Starter donne 5 quiz/jour et 5 PDF/mois avec explications IA basiques. C'est le bon choix si vous voulez un peu plus que le gratuit sans dépenser 22.99$." },
